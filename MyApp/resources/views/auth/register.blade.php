            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="dateNaissance" class="col-md-4 col-form-label text-md-end">{{ __('dateNaissance Addresse') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="annexe" class="col-md-4 col-form-label text-md-end">{{ __('Annexe') }}</label>
